...
const Insights = () => {
  ...
  return (
    <Layout>
      <div>
        <div className="right-4 m-4 flex flex-col items-center justify-between rounded-lg bg-gold p-8 md:flex-row">
        ...
        <div className="flex w-full flex-col items-start gap-4 md:m-4 md:flex-row">
          <div className="flex w-fit flex-col items-start gap-6 rounded-lg border border-solid border-gray-200 bg-white p-8">
            <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:gap-64">
          ...
          <div className=" flex flex-col flex-wrap items-start gap-6 rounded-lg border border-solid border-gray-200 bg-white p-8">
