  ...
  const handleSubmit = async () => {
    ...
    if (defaultValues) {
      if (
        ...
        (uploadedImage === undefined || uploadedAudio === undefined)
      ) {
        toast.error(
        ...
        updateDevotion(
          ...
          defaultValues.id,
          (defaultValues?.coverImage as unknown as File) === uploadedImage
            ? undefined
            : uploadedImage,
          defaultValues?.attachments.includes(
            uploadedAudio as unknown as string
          )
            ? undefined
            : uploadedAudio
        )
